    ...
    <body>
        <div class="container">
            ...
            <form action="{{ route('store.size') }}" method="post" enctype="multipart/form-data">
                ...
                <label for="name">Add Size:</label>
                <input type="text" class="form-control" name="size" required placeholder="Enter Your size">
                <button type="submit" class="btn btn-success mt-3">Add Size</button>
            </form>
                ...
                <table class="table">
                    ...
                    @foreach ($sizes as $size)
                        <tr>
                            ...
                            <td>{{ $size->size }}</td>
                            <td>
                                <a href="{{ route('delete.size', $size->id) }}" class="btn btn-danger">
